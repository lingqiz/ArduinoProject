...
void setup()
{
  ...
  servo.write(160);  // At angle = 160, the door is locked
...
void loop()
{
  ...
  if(rfid.PICC_IsNewCardPresent())
  {
    if(rfid.PICC_ReadCardSerial())
    {
       ...
       Serial.println(UID);   
       rfid.PICC_HaltA();
       if(UID == 3147815616 || UID == 4185143686 || UID == 4185149142 || UID == 4185087766 || UID == 4185091494)
       {
         servoRotate();
       }
       else
